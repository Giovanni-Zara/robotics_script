...
%%modificare semplicemente il parametro N per impostare il numero di joint
%%e la DH table.
clear all
clc
...
DHTABLE = [  0       sym('l1')     0       sym('q1');
             0       sym('l2')     0       sym('q2');
          ];

%{
     COPIA DI COMODITA' in caso servisse incollare altrove
